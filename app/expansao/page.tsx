...
const [codestatus, sinalizadorcode] = useState<"online" | "offline">("online");
      ...
      <div className="w-full max-w-2xl">
        ...
        <div className="space-y-6">
          ...
          <p className="text-center text-muted-foreground text-lg font-medium">
            Ferramenta para automatizar as tarefas do Expansão Noturno!
          </p>
...
<Badge variant={sinalizadorcode === "offline" ? "destructive" : "default"} className="px-3 py-1">
  {codestatus}
</Badge>
            </CardHeader>
            <CardContent className="space-y-3">
