...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-slate-950 to-black text-white overflow-x-hidden">
      ...
      <motion.main initial="hidden" animate="visible" className="relative z-10 px-4 pb-20">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <input
              type="text"
              placeholder="Pesquisar scripts por título ou categoria..."
              value={searchTerm}
              onChange={(e) => setSearchTerm(e.target.value)}
              className="flex-1 rounded-xl bg-slate-800 text-white px-4 py-2 placeholder:text-slate-500 focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
          ...
          {filteredScripts.length === 0 ? (
            <p className="text-center text-purple-400 mb-10 select-none">
              Nenhum script encontrado para sua pesquisa.
            </p>
          ) : (
