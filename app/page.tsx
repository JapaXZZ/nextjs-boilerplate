...
<div className="fixed inset-0 bg-grid-white/[0.02] bg-[size:60px_60px]" />  {/* Topo com botão de Tutoriais */}
...
</div>    <footer className="relative z-10 py-12 text-center border-t border-purple-800/60 px-4 max-w-7xl mx-auto select-none">    
